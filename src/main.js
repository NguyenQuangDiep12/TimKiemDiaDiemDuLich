...
class TourismMapApp {
    ...
    this.app.innerHTML = `
      <header>
        <div class="d-flex align-items-center gap-2">
          <i class="bi bi-globe-asia-australia" style="color: var(--accent); font-size: 1.5rem;"></i>
          <div class="header-title">WebGIS <span>Tourism Explorer</span></div>
        </div>
  ...
  async initializeComponents() {
    ...
    this.routingPanel = new RoutingPanel('routing-panel', this.mapView)

    this.placesPanel = new PlacesPanel('place-panel', this.mapView, this.routingPanel)
